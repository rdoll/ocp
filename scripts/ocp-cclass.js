...
ocp.cclass = {
    ...
    _getSkillSpec: function (skill) {
        return (this._getCurrent().specialization == ocp.skills[skill].spec ? 5 : 0);
    },
    ...
    _initializeDropdown: function() {
        ...
        for (var cclass in this._data) {
            menu.addChild(new dijit.MenuItem({
                label: cclass,
                onClick: new Function('ocp.cclass.selectPredefined("' + cclass + '")')
            }));
        }
    ...
    _selectPredefined: function(predefined) {
        console.log('entered ocp.cclass._selectPredefined:', predefined);
    ...
    selectPredefined: function(predefined) {
        console.log('entered ocp.cclass.selectPredefined:', predefined);
